...
export default function TermsAndConditions() {
  const { data: doc, isLoading } = useLegalDoc("terms-and-conditions");
          ...
          <div className="max-w-4xl mx-auto">
            {isLoading ? (
              ...
              <div className="text-center py-32">
                ...
                <p className="text-white/40 mb-10 font-body">The terms and conditions document is not available.</p>
                <Link to="/">
